...
STRIPE_SUCCESS_URL = os.getenv("STRIPE_SUCCESS_URL", "https://agentverse.ai/payment-success").strip()
STRIPE_CHECKOUT_EXPIRES_SECONDS = int(os.getenv("STRIPE_CHECKOUT_EXPIRES_SECONDS", "1800"))
